<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Mobile computing.aspx.vb" Inherits="_Default" %>
            ...
            <div id="content">
                ...
                <div id="contentmid">
                    <div class="midheading">
                        <h2>
                           Introduction to Mobile Computing and Communication</h2>
                    </div>
                    <div class="midtxt">
                        <span class="midboldtxt">
                           ...
                           communication. It was merely an extension of the fixed line telephony that allowed
                           ...
                           mobile devices will not only enable Internet access, but will also support 
                    ...
                    <div class="midheading">
                        <h2>
                           Mobile Computing Applications</h2>
                    </div>
                    <div class="midtxt">
                        <span class="midboldtxt">
                        mobile applications that is gaining popularity is mobile commerce or m-commerce, which is likely to become an important application of this technology. M-commerce application can be classified into ten types: 
<br />1.	Mobile financial application (business-to-customer [B2C] and business-to-business [B2B]): The mobile device is used as a powerful financial medium. 
<br />2.	Mobile advertising (B2C): It turns the wireless infrastructure and devices into a powerful marketing medium. 
<br />3.	Mobile inventory management (B2C and B2B) or product locating and shopping (B2C and B2B): It is an attempt to reduce the amount of inventory needed by managing in-house and on-the-move inventory. It also includes applications that help to locate products and services that are needed. 
<br />4.	Proactive service management (B2C and B2B): It attempts to locate products and services that are needed. 
<br />5.	Wireless reengineering (B2C and B2B): It focuses on improving the quality of business services using mobile devices and wireless infrastructure. 
<br />6.	Mobile auction or reverse auction (B2C and B2B): It allows users to buy or sell certain items using multicast support of wireless infrastructure. 
<br />7.	Mobile entertainment services and games (B2C): It provides entertainment services to users on a per-event or subscription basis. 
<br />8.	Mobile office (B2C): It provides the complete office environment to mobile users anywhere, anytime. 
<br />9.	Mobile distance education (B2C): It extends distance or virtual education support for mobile uses everywhere. 
<br />10.	Wireless data center (B2C and B2B): It supports large amounts of stored data to be made available to mobile users for making "intelligent" decisions. 
                   ...
                   <div class="midheading">
                        <h2>  Top Ten Trends in Mobile Computing   </h2>
                    </div>    
                   ...
                   <div class="midtxt">
                        ...
                        <br /> 1 - Long Term Evolution (LTE)
  <br />2 - WiMax
  <br />3 - 3G 
 <br />4 - Smartphone applications
  <br />5 - GPS 
 <br />6 - Security
  <br />7 - Anti-virus 
 <br />8 - Push-button applications
  <br />9 - Supplemental Broadband 
 <br />10 - Solid State Drives

                        </span>
                    </div>
                   
          <div class="midheading">
                        <h3> Long Term Evolution (LTE)   </h3>
                    </div>    
                   ...
                   <div class="midtxt">
                        <span class="midboldtxt">
                        As LTE and WiMax networks are deployed in the U.S. through 2012, expect to see more netbooks and laptops equipped with built-in radio frequency identification (RFID) and wireless support.
                        </span>
                    </div>
                   <div class="midheading">
                        <h3>  3G & 4G interoperability  </h3>
                    </div>    
                   ...
                   <div class="midtxt">
                    ...
                    <div class="midheading">
                        <h3> Push-button applications   </h3>
                    </div>    
